...
let material = null
let points = null
//so that we can destroy the old galaxy

const generateGalaxy = () => {

    if(points !== null){ //destroy old galaxy if something is there
        geometry.dispose()
        material.dispose()
        scene.remove(points)
    }
    ...
    for(let i = 0; i < parameters.count; i++){
        ...
        mixedColor.lerp(colorOutside, radius / parameters.radius) // 0-1 depending on how far from center
